...
couverture = ['702', '708', '714', '720', '726', '730', '736', '742', '748', '754', '760', '810', '814', '818', '822', '826']
...
circ_path = os.path.join('data', 'quebec.json')
...
m = folium.Map([46.867, -71.225], tiles='stamentoner', zoom_start=12)
...
region_quebec_html = os.path.join('docs', 'region_quebec.html')
m.save(region_quebec_html)
